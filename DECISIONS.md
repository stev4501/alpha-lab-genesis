...
This index is append-only. Full decisions live in `docs/adr/`.

- [ADR-0001: Append-only experiment ledger](docs/adr/0001-append-only-experiment-ledger.md)
- [ADR-0002: Evidence ladder instead of proof claims](docs/adr/0002-evidence-ladder.md)
